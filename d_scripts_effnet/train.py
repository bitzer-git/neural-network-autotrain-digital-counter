...
print("Load model path: ", output_dir + TFliteNamingAndVersion + "-q.tflite")
pdf.savefig(evaluate_ziffer_tflite(output_dir + TFliteNamingAndVersion + "-q.tflite", ziffer_files, "Quantized TF-Lite-Model"))
pdf.close()
